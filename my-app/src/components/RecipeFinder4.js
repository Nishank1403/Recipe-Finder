...
export function RecipeFinder({ groceryItems, allergens, setRecipes, currentUser, onAddToFavorites }) {
  ...
  const cuisines = ['Any', 'Italian', 'Mexican', 'Chinese', 'Indian']; // Extend with more cuisines if needed
  const diets = ['Any', 'Vegetarian', 'Vegan', 'Gluten Free', 'Paleo']; // Extend with more diets if needed
